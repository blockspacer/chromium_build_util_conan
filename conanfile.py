...
class chromium_build_util_conan_project(ConanFile):
    name = "chromium_build_util"
    ...
    description = "modified `build_util` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        ...
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "build_util", "compat"))
